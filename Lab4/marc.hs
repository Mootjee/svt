...
-- If we give trClos symClos x a random input [(0,1)] and we give the same random input to trClos symClos x they return different values.
-- trClos sysCol x returns [(0,0),(0,1),(1,0),(1,1)] while symClos trClos x returns [(0,1),(1,0)]
