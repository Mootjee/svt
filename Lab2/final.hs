...
main = do
  ...
  putStrLn "Exercise 02"
  print testEqu
  print testRec
  print testIso
  print testOther
  print testNon
  putStrLn "End of test exercise 02"
  ...
  putStrLn "Exercise 05"
  quickCheckResult $ forAll genNumbers testLengthList
  quickCheckResult $ forAll genN testSameElem''
  putStrLn "End of test exercise 05"

  putStrLn "Exercise 06"
  quickCheckResult $ forAll stringGen testEquality
  quickCheckResult $ forAll stringGen testRotRot
  quickCheckResult $ forAll stringGen testLength
  putStrLn "End of test exercise 06"

  putStrLn "Exercise 07"
  print (testIbanCorrect correctIbanList)
  print (testIbanIncorrect incorrectIbanList)
  print (testIbanIncorrect incorrectLengthList)
  print (testIbanIncorrect shuffledList)

  -- These give a error, thats why they are commented.
  -- This is inteded as my function throws an error for non alpha numeric values.

  -- print (iban "SK311200.000198742637541")
  -- print (iban "SI561910,0000123438")
  -- print (iban "SE355000-000054910000003")
  -- print (iban "CH930076=011623852957")
  -- print (iban "DE893704+0440532013000")
  putStrLn "End of test exercise 07"
